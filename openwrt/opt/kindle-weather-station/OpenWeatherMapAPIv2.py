...
if os.path.exists('GetIconExtra.py'):
    import GetIconExtra as GetIconExtra
else:
    def GetIconExtra():
        return ''
...
class OpenWeatherMap:
    ...
    def __init__(self, settings):
        ...
        OpenWeatherMap.current_weather.icons = dict()
        OpenWeatherMap.hourly_forecast.icons = dict()
        OpenWeatherMap.daily_forecast.icons = dict()
        OpenWeatherMap.header.icons = dict()


    def header(self):
        OpenWeatherMap.header.icons['sunrise'] = GetIcon.getSunrise(self)
        OpenWeatherMap.header.icons['sunset'] = GetIcon.getSunset(self)
    ...
    def current_weather(self):
       ...
       # gust
        ...
        OpenWeatherMap.current_weather.icons[0] = self.add_icon(dat[2])
        OpenWeatherMap.current_weather.icons['cardinal'] = self.add_icon(dat[9])
    ...
    def hourly_forecast(self, hour):
       ...
       # gust
        ...
        OpenWeatherMap.icons = self.add_icon(dat[2])
        OpenWeatherMap.hourly_forecast.icons[hour] = self.add_icon(dat[2])
    ...
    def daily_forecast(self, day):
       ...
       # gust
        ...
        OpenWeatherMap.icons = self.add_icon(dat[2])
        OpenWeatherMap.daily_forecast.icons[day] = self.add_icon(dat[2])
    ...
    def add_icon(self, s):
        if s == 'Clear-day':
            if ("getClearDay" in dir(GetIconExtra)) == True: return GetIconExtra.getClearDay()
            else: return GetIcon.getClearDay(self)
        elif s == 'Clear-night':
            if ("getClearNight" in dir(GetIconExtra)) == True: return GetIconExtra.getClearNight()
            else: return GetIcon.getClearNight(self)
        elif s == 'Rain':
            if ("getRain" in dir(GetIconExtra)) == True: return GetIconExtra.getRain()
            else: return GetIcon.getRain(self)
        elif s == 'Drizzle':
            if ("getDrizzle" in dir(GetIconExtra)) == True: return GetIconExtra.getDrizzle()
            else: return GetIcon.getRain(self)
        elif s == 'Thunderstorm':
            if ("getThunderstorm" in dir(GetIconExtra)) == True: return GetIconExtra.getThunderstorm()
            else: return GetIcon.getRain(self)
        elif s == 'Snow':
            if ("getSnow" in dir(GetIconExtra)) == True: return GetIconExtra.getSnow()
            else: return GetIcon.getSnow(self)
        elif s == 'Sleet':
            if ("getSleet" in dir(GetIconExtra)) == True: return GetIconExtra.getSleet()
            else: return GetIcon.getRain(self)
        elif s == 'Wind':
            if ("getWind" in dir(GetIconExtra)) == True: return GetIconExtra.getWind()
            else: return GetIcon.getWind(self)
        elif s == 'Clouds':
            if ("getCloudy" in dir(GetIconExtra)) == True: return GetIconExtra.getCloudy()
            else: return GetIcon.getCloudy(self)
        elif s == 'Few-clouds-day':
            if ("getPartlyCloudyDay" in dir(GetIconExtra)) == True: return GetIconExtra.getPartlyCloudyDay()
            else: return GetIcon.getPartlyCloudyDay(self)
        elif s == 'Few-clouds-night':
            if ("getPartlyCloudyNight" in dir(GetIconExtra)) == True: return GetIconExtra.getPartlyCloudyNight()
            else: return GetIcon.getPartlyCloudyNight(self)
        elif s == 'Mist':
            if ("getMist" in dir(GetIconExtra)) == True: return GetIconExtra.getMist()
            else: return GetIcon.getFog(self)
        elif s == 'Smoke':
            if ("getSmoke" in dir(GetIconExtra)) == True: return GetIconExtra.getSmoke()
            else: return GetIcon.getFog(self)
        elif s == 'Haze':
            if ("getHaze" in dir(GetIconExtra)) == True: return GetIconExtra.getHaze()
            else: return GetIcon.getFog(self)
        elif s == 'Dust':
            if ("getDust" in dir(GetIconExtra)) == True: return GetIconExtra.getDust()
            else: return GetIcon.getFog(self)
        elif s == 'Fog':
            if ("getFog" in dir(GetIconExtra)) == True: return GetIconExtra.getFog()
            else: return GetIcon.getFog(self)
        elif s == 'Sand':
            if ("getSand" in dir(GetIconExtra)) == True: return GetIconExtra.getSand()
            else: return GetIcon.getFog(self)
        elif s == 'Dust':
            if ("getDust" in dir(GetIconExtra)) == True: return GetIconExtra.getDust()
            else: return GetIcon.getFog(self)
        elif s == 'Ash':
            if ("getAsh" in dir(GetIconExtra)) == True: return GetIconExtra.getAsh()
            else: return GetIcon.getFog(self)
        elif s == 'Squall':
            if ("getSquall" in dir(GetIconExtra)) == True: return GetIconExtra.getSquall()
            else: return GetIcon.getRain(self)
        elif s == 'Tornado':
            if ("getTornado" in dir(GetIconExtra)) == True: return GetIconExtra.getTornado()
            else: return GetIcon.getWind(self)
        elif s == 'Cyclone':
            if ("getCyclone" in dir(GetIconExtra)) == True: return GetIconExtra.getCyclone()
            else: return GetIcon.getWind(self)
        elif s == 'Snow2':
            if ("getSnow2" in dir(GetIconExtra)) == True: return GetIconExtra.getSnow2()
            else: return GetIcon.getSnow(self)
        elif s == 'N':
            return GetIcon.getDirectionDown(self)
        elif s == 'NE':
            return GetIcon.getDirectionDownLeft(self)
        elif s == 'E':
            return GetIcon.getDirectionLeft(self)
        elif s == 'SE':
            return GetIcon.getDirectionUpLeft(self)
        elif s == 'S':
            return GetIcon.getDirectionUp(self)
        elif s == 'SW':
            return GetIcon.getDirectionUpRight(self)
        elif s == 'W':
            return GetIcon.getDirectionRight(self)
        elif s == 'NW':
            return GetIcon.getDirectionDownRight(self)
...
class GetIcon:
    ...
    def getDirectionDownRight(self):
